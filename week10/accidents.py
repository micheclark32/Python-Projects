...
def main():
    try:
        ...
        print(
            f"{filename} does not exist or you can not view. Please choose a different file.")

    except ValueError as val_err:
        print("Error:", val_err)

    except (csv.Error, KeyError) as error:
        print(f"Error: line {reader.line_num} of {filename} is"
              " formatted incorrectly.")

    except ZeroDivisionError as zero_div_err:
        print(f"Error: line {reader.line_num} of {filename} contains"
