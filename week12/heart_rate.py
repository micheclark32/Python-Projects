...
def populate_main_window(frm_main):
    ...
    lbl_label2 = tk.Label(frm_main, text="Radius:")

    # Create a integer entry box where the user will enter her age.
    ent_rad = numy.IntEntry(frm_main, 1, 360, width=5)

    # Create a label that displays "Rates:"
    lbl_label = tk.Label(frm_main, text="Area:")
    ...
    lbl_label2.grid(row=0, column=0, padx=3, pady=3)
    ent_rad.grid(row=0, column=1, padx=3, pady=3)
    lbl_label.grid(row=0, column=2, padx=(30, 3), pady=3)
