...
def print_death_age(people_dict):
    ...
    for key in people_dict:
        ...
        person_birth = person[BIRTH_YEAR_INDEX]
        person_death = person[DEATH_YEAR_INDEX]
        person_name = person[NAME_INDEX]
        age_at_death = person_death - person_birth

    print(f"{person_name}, {age_at_death}")
    pass
